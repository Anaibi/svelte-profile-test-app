var app = (function () {
	...
	function oncreate$1() {
		// var banner = {}; this.set({banner});
		// var profile = this.get().profile;
		// console.log(profile);
			// .then(profile => {
			// 	this.set({banner: profile.banner});
			// });
	...
	/* src/components/BoostListItem.html generated by Svelte v2.4.4 */
	...
	function create_main_fragment$23(component, ctx) {
		var li, await_block_1, await_block_type, await_token, promise, resolved, text, div, p, text_1_value = ctx.boost.review.content.text, text_1, text_2, text_4, button;
		...
		var stars_initial_data = { rating: ctx.boost.review.rating };
		var stars = new Stars({
			root: component.root,
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if ((changed.boost) && text_1_value !== (text_1_value = ctx.boost.review.content.text)) {
					text_1.data = text_1_value;
				}

				var stars_changes = {};
				if (changed.boost) stars_changes.rating = ctx.boost.review.rating;
	...
	function BoostListItem(options) {
		this._debugName = '<BoostListItem>';
		if (!options || (!options.target && !options.root)) throw new Error("'target' is a required option");
		init(this, options);
		this._state = assign(data$2(), options.data);
		if (!('user' in this._state)) console.warn("<BoostListItem> was created without expected data property 'user'");
		if (!('boost' in this._state)) console.warn("<BoostListItem> was created without expected data property 'boost'");
	...
	assign(BoostListItem.prototype, protoDev);
	assign(BoostListItem.prototype, methods);

	BoostListItem.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};
	...
	function create_main_fragment$24(component, ctx) {
		var slot_content_default = component._slotted.default, slot_content_default_before, slot_content_default_after, text, main, h2, span, text_1, text_2, await_block_2, await_block_type, await_token, promise, resolved, text_3, h2_1, span_1, text_4, a, text_7, ul, await_block_3, await_block_type_1, await_token_1, promise_1, resolved_1;
		...
		function handle_promise(promise) {
			...
			if (isPromise(promise)) {
				promise.then(function(value) {
					resolved = { projects: value };
					replace_await_block(token, create_then_block_2, assign(assign({}, ctx), resolved));
				}, function (error) {
					resolved = { error: error };
					replace_await_block(token, create_catch_block_2, assign(assign({}, ctx), resolved));
				});

				// if we previously had a then/catch block, destroy it
				if (await_block_type !== create_pending_block_2) {
					replace_await_block(token, create_pending_block_2, ctx);
					return true;
				}
			} else {
				resolved = { projects: promise };
				if (await_block_type !== create_then_block_2) {
					replace_await_block(token, create_then_block_2, assign(assign({}, ctx), resolved));
					return true;
				}
			}
		...
		handle_promise(promise = ctx.projects);
		...
		function handle_promise_1(promise_1) {
			...
			if (isPromise(promise_1)) {
				promise_1.then(function(value_1) {
					resolved_1 = { boosts: value_1 };
					replace_await_block_1(token_1, create_then_block_3, assign(assign({}, ctx), resolved_1));
				}, function (error_1) {
					resolved_1 = { error: error_1 };
					replace_await_block_1(token_1, create_catch_block_3, assign(assign({}, ctx), resolved_1));
				});

				// if we previously had a then/catch block, destroy it
				if (await_block_type_1 !== create_pending_block_3) {
					replace_await_block_1(token_1, create_pending_block_3, ctx);
					return true;
				}
			} else {
				resolved_1 = { boosts: promise_1 };
				if (await_block_type_1 !== create_then_block_3) {
					replace_await_block_1(token_1, create_then_block_3, assign(assign({}, ctx), resolved_1));
					return true;
				}
			}
		...
		handle_promise_1(promise_1 = ctx.boosts);
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if (!slot_content_default) {
						...
						if (('projects' in changed) && promise !== (promise = ctx.projects) && handle_promise(promise, ctx)) ; else {
						await_block_2.p(changed, assign(assign({}, ctx), resolved));
					}

						if (('boosts' in changed) && promise_1 !== (promise_1 = ctx.boosts) && handle_promise_1(promise_1, ctx)) ; else {
	...
	function create_if_block$2(component, ctx) {
		var div, header, await_block_1, await_block_type, await_token, promise, resolved, text, button, span, text_2, div_1, div_2, button_1, text_6, p, text_7_value = ctx.details.followers, text_7, div_class_value;
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if ((changed.details) && text_7_value !== (text_7_value = ctx.details.followers)) {
	...
	function create_if_block_1$1(component, ctx) {
		var header, await_block_1, await_block_type, await_token, promise, resolved, text, div, button, span, text_1, text_2, div_1, div_2, h2, text_4, p, text_5_value = ctx.details.followers, text_5, text_7, div_3, h2_1, text_9, p_1, text_10_value = ctx.details.following, text_10, text_13, div_4, h2_2, text_15, p_2, text_16_value = ctx.details.performance, text_16, text_17, span_1, text_18, text_19_value = ctx.details.reviews, text_19, text_20, div_class_value;
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if ((changed.details) && text_5_value !== (text_5_value = ctx.details.followers)) {
					text_5.data = text_5_value;
				}

				if ((changed.details) && text_10_value !== (text_10_value = ctx.details.following)) {
					text_10.data = text_10_value;
				}

				if ((changed.details) && text_16_value !== (text_16_value = ctx.details.performance)) {
					text_16.data = text_16_value;
				}

				if ((changed.details) && text_19_value !== (text_19_value = ctx.details.reviews)) {
	...
	function create_then_block_2(component, ctx) {
		...
		var tiles_initial_data = { tiles: ctx.projects };
		var tiles = new Tiles({
			root: component.root,
		...
		return {
			...
			m: function mount(target, anchor) {
				tiles._mount(target, anchor);
			},

			p: function update(changed, ctx) {
				var tiles_changes = {};
				if (changed.projects) tiles_changes.tiles = ctx.projects;
	...
	// (71:18)     {:then boosts}
	function create_pending_block_3(component, ctx) {
	...
	// (73:4) {#each boosts as boost}
	function create_each_block$2(component, ctx) {

		var boostlistitem_initial_data = { boost: ctx.boost };
		var boostlistitem = new BoostListItem({
			root: component.root,
			data: boostlistitem_initial_data
		});

		return {
			c: function create() {
				boostlistitem._fragment.c();
			},

			m: function mount(target, anchor) {
				boostlistitem._mount(target, anchor);
			},

			p: function update(changed, ctx) {
				var boostlistitem_changes = {};
				if (changed.boosts) boostlistitem_changes.boost = ctx.boost;
				boostlistitem._set(boostlistitem_changes);
			},

			u: function unmount() {
				boostlistitem._unmount();
			},

			d: function destroy$$1() {
				boostlistitem.destroy(false);
			}
		};
	}

	// (72:3) {:then boosts}
	function create_then_block_3(component, ctx) {

		var each_value = ctx.boosts;
				...
				if (changed.boosts) {
					...
					for (var i = 0; i < each_value.length; i += 1) {
						...
						if (each_blocks[i]) {
							...
							each_blocks[i].c();
							each_blocks[i].m(null.parentNode, null);
						}
					}
	...
	// (76:3) {:catch error}
	function create_catch_block_3(component, ctx) {
	...
	function SidebarProfile(options) {
		...
		if (!('details' in this._state)) console.warn("<SidebarProfile> was created without expected data property 'details'");
		if (!('animate' in this._state)) console.warn("<SidebarProfile> was created without expected data property 'animate'");
		if (!('projects' in this._state)) console.warn("<SidebarProfile> was created without expected data property 'projects'");
		if (!('boosts' in this._state)) console.warn("<SidebarProfile> was created without expected data property 'boosts'");
	...
	assign(SidebarProfile.prototype, methods$1);
	...
	function create_then_block$4(component, ctx) {
		...
		var stars_initial_data = { rating: ctx.details.rating };
		var stars = new Stars({
			root: component.root,
			data: stars_initial_data
		});
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				var stars_changes = {};
				if (changed.details) stars_changes.rating = ctx.details.rating;
				stars._set(stars_changes);
			},
	...
	function HeaderProfile(options) {
		...
		if (!('details' in this._state)) console.warn("<HeaderProfile> was created without expected data property 'details'");
	...
	assign(PostTitle.prototype, methods$2);
	...
	assign(SponsoredPost.prototype, methods$3);
	...
	function create_main_fragment$29(component, ctx) {
		var div, div_1, div_2, text, div_3, await_block_2, await_block_type, await_token, promise, resolved, text_1, text_4, div_4, span, text_5_value = ctx.post.review.rating, text_5, text_6, span_1, text_10, div_5, p, raw_value = ctx.post.review.content.text, text_11, await_block_3, await_block_type_1, await_token_1, promise_1, resolved_1;
		...
		return {
			...
			p: function update(changed, _ctx) {
				...
				if ((changed.post) && text_5_value !== (text_5_value = ctx.post.review.rating)) {
					text_5.data = text_5_value;
				}
		...
		function handle_promise(promise) {
			...
			if (isPromise(promise)) {
				promise.then(function(value) {
					...
					replace_await_block(token, create_then_block$8, assign(assign({}, ctx), resolved));
				}, function (error) {
					resolved = { error: error };
					replace_await_block(token, create_catch_block$8, assign(assign({}, ctx), resolved));
				});

				// if we previously had a then/catch block, destroy it
				if (await_block_type !== create_pending_block$8) {
					replace_await_block(token, create_pending_block$8, ctx);
					return true;
				}
			} else {
				resolved = { posts: promise };
				if (await_block_type !== create_then_block$8) {
					replace_await_block(token, create_then_block$8, assign(assign({}, ctx), resolved));
					return true;
				}
			}
	...
	// (1:14)    <!-- todo add loading element -->   <p>LOADIING POSTS</p> {:then posts}
	...
	// (20:8) {#if post.isReview}
	function create_if_block_4(component, ctx) {

		var reviewpost_initial_data = { post: ctx.post, user: ctx.user };
	...
	function create_main_fragment$35(component, ctx) {
		...
		function switch_props(ctx) {
			var switch_instance_initial_data = { user: ctx.user };
			return {
				root: component.root,
	...
	assign(ContentProfile.prototype, methods$5);

	ContentProfile.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};

	/* src/components/FollowListItem.html generated by Svelte v2.4.4 */



	function create_main_fragment$36(component, ctx) {
		var li, text, div, p, text_1_value = ctx.user.name, text_1, text_2, p_1, text_3_value = ctx.user.title, text_3, text_5, button;
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if ((changed.user) && text_1_value !== (text_1_value = ctx.user.name)) {
					text_1.data = text_1_value;
				}

				if ((changed.user) && text_3_value !== (text_3_value = ctx.user.title)) {
	...
	function FollowListItem(options) {
		this._debugName = '<FollowListItem>';
		if (!options || (!options.target && !options.root)) throw new Error("'target' is a required option");
		init(this, options);
		this._state = assign({}, options.data);
		if (!('user' in this._state)) console.warn("<FollowListItem> was created without expected data property 'user'");
	...
	assign(FollowListItem.prototype, protoDev);

	FollowListItem.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};

	/* src/components/HiringListItem.html generated by Svelte v2.4.4 */



	function create_main_fragment$37(component, ctx) {
		var li, a, p, text_value = ctx.user.name, text, text_1, p_1, text_2_value = ctx.user.location, text_2, a_href_value;
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if ((changed.user) && text_2_value !== (text_2_value = ctx.user.location)) {
					text_2.data = text_2_value;
				}
	...
	function HiringListItem(options) {
		this._debugName = '<HiringListItem>';
		if (!options || (!options.target && !options.root)) throw new Error("'target' is a required option");
		init(this, options);
		this._state = assign({}, options.data);
		if (!('user' in this._state)) console.warn("<HiringListItem> was created without expected data property 'user'");
	...
	assign(HiringListItem.prototype, protoDev);

	HiringListItem.prototype._checkReadOnly = function _checkReadOnly(newState) {
	};
	...
	function create_main_fragment$38(component, ctx) {
		var main, slot_content_default = component._slotted.default, section, h2, text_2, img, img_src_value, img_alt_value, text_3, p, a_1, text_4_value = ctx.highlight.title, text_4, a_1_href_value, text_5, p_1, text_6_value = ctx.highlight.description, text_6, text_8, section_1, h2_1, text_11, ul, text_13, section_2, h2_2, text_16, ul_1;

		var each_value = ctx.usersFollow;
		...
		var each_value_1 = ctx.usersHiring;
		...
		return {
			c: function create() {
				...
				if (!slot_content_default) {
					...
					h2_2 = createElement("h2");
					h2_2.innerHTML = "Now hiring <a class=\"right link\" href=\"/\">More</a>";
					text_16 = createText("\n      ");
				...
				if (!slot_content_default) {
					h2.className = "title";
					img.src = img_src_value = ctx.highlight.img;
					img.alt = img_alt_value = ctx.highlight.title;
					a_1.href = a_1_href_value = ctx.highlight.link;
			...
			m: function mount(target, anchor) {
				...
				if (!slot_content_default) {
					...
					appendNode(section_1, main);
					appendNode(h2_1, section_1);
					appendNode(text_11, section_1);
					...
					appendNode(text_13, main);
					appendNode(section_2, main);
					appendNode(h2_2, section_2);
					appendNode(text_16, section_2);
					appendNode(ul_1, section_2);
			...
			p: function update(changed, ctx) {
				if (!slot_content_default) {
					if ((changed.highlight) && img_src_value !== (img_src_value = ctx.highlight.img)) {
						img.src = img_src_value;
					}

					if ((changed.highlight) && img_alt_value !== (img_alt_value = ctx.highlight.title)) {
						img.alt = img_alt_value;
					}

					if ((changed.highlight) && text_4_value !== (text_4_value = ctx.highlight.title)) {
						text_4.data = text_4_value;
					}

					if ((changed.highlight) && a_1_href_value !== (a_1_href_value = ctx.highlight.link)) {
						a_1.href = a_1_href_value;
					}

					if ((changed.highlight) && text_6_value !== (text_6_value = ctx.highlight.description)) {
						text_6.data = text_6_value;
					}

						if (changed.usersFollow) {
						each_value = ctx.usersFollow;
						...
						if (changed.usersHiring) {
						each_value_1 = ctx.usersHiring;
	...
	// (13:8) {#each usersFollow as user}
	function create_each_block$6(component, ctx) {

		var followlistitem_initial_data = { user: ctx.user };
		var followlistitem = new FollowListItem({
			root: component.root,
			data: followlistitem_initial_data
		});

		return {
			c: function create() {
				followlistitem._fragment.c();
			},

			m: function mount(target, anchor) {
				followlistitem._mount(target, anchor);
			},

			p: function update(changed, ctx) {
				var followlistitem_changes = {};
				if (changed.usersFollow) followlistitem_changes.user = ctx.user;
				followlistitem._set(followlistitem_changes);
			},

			u: function unmount() {
				followlistitem._unmount();
			},

			d: function destroy$$1() {
				followlistitem.destroy(false);
			}
		};
	}

	// (22:8) {#each usersHiring as user}
	function create_each_block_1(component, ctx) {

		var hiringlistitem_initial_data = { user: ctx.user };
		var hiringlistitem = new HiringListItem({
			root: component.root,
			data: hiringlistitem_initial_data
		});

		return {
			c: function create() {
				hiringlistitem._fragment.c();
			},

			m: function mount(target, anchor) {
				hiringlistitem._mount(target, anchor);
			},

			p: function update(changed, ctx) {
				var hiringlistitem_changes = {};
				if (changed.usersHiring) hiringlistitem_changes.user = ctx.user;
				hiringlistitem._set(hiringlistitem_changes);
			},

			u: function unmount() {
				hiringlistitem._unmount();
			},

			d: function destroy$$1() {
				hiringlistitem.destroy(false);
			}
		};
	}
	...
	function SidebarContent(options) {
		...
		if (!('highlight' in this._state)) console.warn("<SidebarContent> was created without expected data property 'highlight'");
		if (!('usersFollow' in this._state)) console.warn("<SidebarContent> was created without expected data property 'usersFollow'");
		if (!('usersHiring' in this._state)) console.warn("<SidebarContent> was created without expected data property 'usersHiring'");
	...
	assign(SidebarContent.prototype, methods$6);
	...
	function create_main_fragment$39(component, ctx) {
		...
		var banner_initial_data = { banner: ctx.banner, blur: ctx.blur };
		...
		var sidebarcontent_initial_data = { id: ctx.profileId };
		var sidebarcontent = new SidebarContent({
			root: component.root,
			data: sidebarcontent_initial_data
		});
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				var banner_changes = {};
				if (changed.banner) banner_changes.banner = ctx.banner;
				if (changed.blur) banner_changes.blur = ctx.blur;
				banner._set(banner_changes);

				var sidebarprofile_changes = {};
				if (changed.profileDetails) sidebarprofile_changes.details = ctx.profileDetails;
				...
				if (changed.profileDetails) headerprofile_changes.details = ctx.profileDetails;
				...
				var sidebarcontent_changes = {};
				if (changed.profileId) sidebarcontent_changes.id = ctx.profileId;
				sidebarcontent._set(sidebarcontent_changes);
			},
	...
	function App(options) {
		...
		if (!('banner' in this._state)) console.warn("<App> was created without expected data property 'banner'");
		if (!('blur' in this._state)) console.warn("<App> was created without expected data property 'blur'");
		if (!('profileDetails' in this._state)) console.warn("<App> was created without expected data property 'profileDetails'");
		...
		if (!('profileId' in this._state)) console.warn("<App> was created without expected data property 'profileId'");
