var app = (function () {
	...
	function create_main_fragment$14(component, ctx) {
		var header, slot_content_header = component._slotted.header, img, img_src_value, text, button, span, text_1, text_2, div, div_1, h2, text_4, p, text_5_value = ctx.user.followers, text_5, text_7, div_2, h2_1, text_9, p_1, text_10_value = ctx.user.following, text_10, text_13, div_3, h2_2, text_15, p_2, text_16_value = ctx.user.perf, text_16, text_17, span_1, text_18, text_19_value = ctx.user.reviews, text_19, text_20, text_24, main, slot_content_default = component._slotted.default, h2_3, span_2, text_25, text_26, div_4, text_27, h2_4, span_3, text_28, a, text_30, div_5;
		...
		return {
			c: function create() {
				...
				if (!slot_content_header) {
					img.className = "profile-img img svelte-1gu85kv";
					img.src = img_src_value = ctx.user.img;
					img.alt = "Profile Image";
					span.className = "icon svelte-1gu85kv";
					button.className = "btn svelte-1gu85kv";
					h2.className = "svelte-1gu85kv";
					p.className = "highlight info svelte-1gu85kv";
					div_1.className = "col";
					h2_1.className = "svelte-1gu85kv";
					p_1.className = "highlight info svelte-1gu85kv";
					div_2.className = "col";
					div.className = "info-row lg row svelte-1gu85kv";
					h2_2.className = "svelte-1gu85kv";
					span_1.className = "note svelte-1gu85kv";
					p_2.className = "highlight info svelte-1gu85kv";
					div_3.className = "col info-row svelte-1gu85kv";
				}
				header.className = "svelte-1gu85kv";
				if (!slot_content_default) {
					span_2.className = "icon svelte-1gu85kv";
					h2_3.className = "svelte-1gu85kv";
					div_4.className = "tiles";
					span_3.className = "icon icon-star svelte-1gu85kv";
					a.className = "highlight right";
					a.href = "/";
					h2_4.className = "svelte-1gu85kv";
					div_5.className = "rows";
				}
				main.className = "svelte-1gu85kv";
			},
	...
	function setStars(node) {
		var stars = this.get().user.stars; stars = 3.5;
