var app = (function () {
	...
	function create_main_fragment$13(component, ctx) {
		var header, slot_content_header = component._slotted.header, img, img_src_value, text, button, span, text_1, text_2, div, div_1, h2, text_4, p, text_5_value = ctx.user.followers, text_5, text_7, div_2, h2_1, text_9, p_1, text_10_value = ctx.user.following, text_10, text_13, div_3, h2_2, text_15, p_2, text_16_value = ctx.user.perf, text_16, text_17, span_1, text_18, text_19_value = ctx.user.reviews, text_19, text_20, text_24, main, slot_content_default = component._slotted.default, h2_3, span_2, text_25, text_26, div_4, text_27, h2_4, text_30, div_5;
		...
		return {
			c: function create() {
				...
				if (!slot_content_default) {
					...
					text_25 = createText(" Projects");
					text_26 = createText("\n\t\t");
					div_4 = createElement("div");
					text_27 = createText("\n\t\t");
					h2_4 = createElement("h2");
					h2_4.innerHTML = "<span class=\"icon-star svelte-su2noh\"></span> Boosts <a class=\"highlight right\" href=\"/\">More</a>";
					text_30 = createText("\n\t\t");
					div_5 = createElement("div");
				}
				if (!slot_content_header) {
					img.className = "profile-img img svelte-su2noh";
					img.src = img_src_value = ctx.user.img;
					img.alt = "Profile Image";
					span.className = "icon svelte-su2noh";
					button.className = "btn svelte-su2noh";
					h2.className = "svelte-su2noh";
					p.className = "highlight info svelte-su2noh";
					div_1.className = "col";
					h2_1.className = "svelte-su2noh";
					p_1.className = "highlight info svelte-su2noh";
					div_2.className = "col";
					div.className = "info-row lg row svelte-su2noh";
					h2_2.className = "svelte-su2noh";
					span_1.className = "note svelte-su2noh";
					p_2.className = "highlight info svelte-su2noh";
					div_3.className = "col info-row svelte-su2noh";
				}
				header.className = "svelte-su2noh";
				if (!slot_content_default) {
					span_2.className = "icon svelte-su2noh";
					h2_3.className = "svelte-su2noh";
					div_4.className = "tiles";
					h2_4.className = "svelte-su2noh";
					div_5.className = "rows";
				}
				main.className = "svelte-su2noh";
			},
	...
	function create_main_fragment$14(component, ctx) {
		var div, h1, text_value = ctx.user.name, text, text_1, p, text_2_value = ctx.user.title, text_2, text_3, span, setStars_action, text_5, div_1, button, span_1, text_6, button_1;
		...
		return {
			c: function create() {
				...
				h1.className = "svelte-1ow9lz7";
				span.className = "icon-stars svelte-1ow9lz7";
				setStars_action = setStars.call(component, span) || {};
				p.className = "svelte-1ow9lz7";
				span_1.className = "icon svelte-1ow9lz7";
				div_1.className = "row";
			},
	...
	function create_main_fragment$21(component, ctx) {
		...
		return {
			c: function create() {
				...
				link.rel = "stylesheet";
				header.className = "row vCentered svelte-c7duxl";
				div_4.className = "content svelte-c7duxl";
				div_3.className = "row";
				main.className = "svelte-c7duxl";
				div_2.className = "row";
				div_1.className = "scroll";
				div.className = "page sidenav svelte-c7duxl";
			},
