var app = (function () {
	...
	function create_main_fragment(component, ctx) {
		...
		return {
			c: function create() {
				...
				if_block.c();
				span.className = "icon";
				a.className = a_class_value = "menu-item " + (ctx.item.active ? 'active' : '') + " svelte-1dg4hzk";
			...
			p: function update(changed, ctx) {
				...
				if ((changed.item) && a_class_value !== (a_class_value = "menu-item " + (ctx.item.active ? 'active' : '') + " svelte-1dg4hzk")) {
	...
	function create_main_fragment$4(component, ctx) {
		var header, slot_content_header = component._slotted.header, img, img_src_value, text, button, text_2, div, div_1, h2, text_4, p, text_5_value = ctx.user.followers, text_5, text_7, div_2, h2_1, text_9, p_1, text_10_value = ctx.user.following, text_10, text_13, div_3, h2_2, text_15, p_2, text_16_value = ctx.user.perf, text_16, text_17, span_1, text_18, text_19_value = ctx.user.reviews, text_19, text_20, text_24, main, slot_content_default = component._slotted.default, h2_3, text_26, div_4, text_27, h2_4, text_30, div_5;
		...
		return {
			c: function create() {
				...
				if (!slot_content_default) {
					...
					h2_4.innerHTML = "<span class=\"icon-star\"></span> Boosts <a class=\"highlight right\" href=\"/\">More</a>";
					text_30 = createText("\n\t\t");
					div_5 = createElement("div");
				}
				if (!slot_content_header) {
					img.className = "profile-img img svelte-14c5ygk";
					img.src = img_src_value = ctx.user.img;
					img.alt = "Profile Image";
					button.className = "btn svelte-14c5ygk";
					h2.className = "svelte-14c5ygk";
					p.className = "highlight info svelte-14c5ygk";
					div_1.className = "col";
					h2_1.className = "svelte-14c5ygk";
					p_1.className = "highlight info svelte-14c5ygk";
					div_2.className = "col";
					div.className = "info-row lg row svelte-14c5ygk";
					h2_2.className = "svelte-14c5ygk";
					span_1.className = "note svelte-14c5ygk";
					p_2.className = "highlight info svelte-14c5ygk";
					div_3.className = "col info-row svelte-14c5ygk";
				}
				header.className = "svelte-14c5ygk";
				if (!slot_content_default) {
					h2_3.className = "svelte-14c5ygk";
					div_4.className = "tiles";
					h2_4.className = "svelte-14c5ygk";
					div_5.className = "rows";
				}
				main.className = "svelte-14c5ygk";
			},
