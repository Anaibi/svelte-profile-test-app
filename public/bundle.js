var app = (function () {
	...
	function create_main_fragment$20(component, ctx) {
		...
		return {
			...
			p: function update(changed, ctx) {
				if (!slot_content_default) {
					if ((changed.profile) && img_src_value !== (img_src_value = ctx.profile.user.img)) {
						img.src = img_src_value;
					}

					if ((changed.profile) && img_alt_value !== (img_alt_value = ctx.profile.user.name)) {
						img.alt = img_alt_value;
					}
	...
	/* src/Stars.html generated by Svelte v2.4.4 */
	...
	function create_main_fragment$22(component, ctx) {
		var div, h1, text_value = ctx.profile.user.name, text, text_1, p, text_2_value = ctx.profile.user.title, text_2, text_3, text_5, div_1, button, span, text_6, button_1;
		...
		return {
			...
			p: function update(changed, ctx) {
				if ((changed.profile) && text_value !== (text_value = ctx.profile.user.name)) {
					text.data = text_value;
				}

				if ((changed.profile) && text_2_value !== (text_2_value = ctx.profile.user.title)) {
	...
	function create_main_fragment$25(component, ctx) {
		var p, strong, text, text_1, span, span_1, text_2, text_3, text_4;
		...
		return {
			c: function create() {
				...
				iconssvg._fragment.c();
				text_2 = createText(" ");
				text_3 = createText(ctx.postPeriod);
				text_4 = createText("\n  ");
				if (if_block) if_block.c();
				span_1.className = "icon svelte-1c1335q";
				span.className = "note svelte-1c1335q";
				p.className = "post-title svelte-1c1335q";
			},
	...
	function create_if_block$2(component, ctx) {
		...
		return {
			c: function create() {
				...
				text_1 = createText(" ");
				button = createElement("button");
				span.className = "right note italic svelte-1c1335q";
				button.className = "icon-btn svelte-1c1335q";
			},
	...
	// (6:12) {#each post.recommendations.users as user}
	...
	// (10:14) {#if post.recommendations.rating}
	...
	// (13:14) {#if post.recommendations.total > 0}
	...
	// (22:8) {#each post.recommendations.users as user}
	...
	// (26:10) {#if post.recommendations.rating}
	...
	// (29:10) {#if post.recommendations.total > 0}
	...
	function create_main_fragment$28(component, ctx) {
		...
		return {
			c: function create() {
				div = createElement("div");
				div.className = "post-text svelte-zzlrh0";
			},
	...
	function create_main_fragment$29(component, ctx) {
		...
		return {
			c: function create() {
				...
				span.className = "icon icon-star svelte-17hi07o";
				span_1.className = "text svelte-17hi07o";
				addListener(button, "click", click_handler);
				button.className = button_class_value = "" + (ctx.starsActive ? 'active' : '') + " svelte-17hi07o";
				span_2.className = "icon icon-message svelte-17hi07o";
				span_3.className = "text svelte-17hi07o";
				a.className = "link svelte-17hi07o";
				a.href = a_href_value = ctx.details.comments.link;
				span_4.className = "icon svelte-17hi07o";
				span_5.className = span_5_class_value = "" + (ctx.details.answers.total > 0 ? ctx.details.answers.total : '') + " svelte-17hi07o";
				a_1.href = "details.answers.link";
				a_1.className = "svelte-17hi07o";
				div_1.className = "left row";
				span_6.className = "icon svelte-17hi07o";
				button_1.className = "svelte-17hi07o";
				div_2.className = "right";
				div.className = "details row svelte-17hi07o";
			},
			...
			p: function update(changed, ctx) {
				...
				if ((changed.starsActive) && button_class_value !== (button_class_value = "" + (ctx.starsActive ? 'active' : '') + " svelte-17hi07o")) {
				...
				if ((changed.details) && span_5_class_value !== (span_5_class_value = "" + (ctx.details.answers.total > 0 ? ctx.details.answers.total : '') + " svelte-17hi07o")) {
	...
	assign(PostDetails.prototype, methods);
	...
	function create_each_block$3(component, ctx) {
		...
		return {
			c: function create() {
				...
				article.className = "post svelte-dtxcjx";
			},
	...
	function create_if_block_1$2(component, ctx) {
		...
		return {
			...
			p: function update(changed, ctx) {
				var avatar_changes = {};
				if (changed.profile) avatar_changes.user = ctx.profile.user;
				avatar._set(avatar_changes);
			},
	...
	function create_if_block_3$1(component, ctx) {
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if (changed.profile) posttitle_changes.name = ctx.profile.user.name;
	...
	assign(ContentProfile.prototype, methods$1);
	...
	function create_main_fragment$36(component, ctx) {
		...
		return {
			c: function create() {
				...
				link.rel = "stylesheet";
				header.className = "row vCentered svelte-zvieny";
				div_4.className = "content svelte-zvieny";
				div_3.className = "row";
				main.className = "svelte-zvieny";
				div_2.className = "row";
				div_1.className = "scroll";
				div.className = "page sidenav svelte-zvieny";
			},
